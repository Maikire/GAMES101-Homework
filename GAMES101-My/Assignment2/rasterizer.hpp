...
namespace rst
{
    ...
    private:
        ...
        void rasterize_triangle_normal(const Triangle& t, const Vector3f& pix, const array<Eigen::Vector4f, 3>& v);
        void rasterize_triangle_msaa_2x(const Triangle& t, const Vector3f& pix, const array<Eigen::Vector4f, 3>& v);
